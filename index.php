...
$controller = new ProblemaController($gestor);
$usuarioController = new UsuarioController($gestor);

$accion = $_GET['accion'] ?? 'index';

// --- LOgica de cookies: RE-AUTENTICACIÓN AUTOMÁTICA ---
// Si NO hay sesión iniciada, pero SI existe la cookie "usuario_login"
if (!isset($_SESSION['usuariod_Id']) && isset($_COOKIE['usuario_login'])) {

    // 1. Recupereamos el email que guardamos en la cookie /estaba en Base64)
...
switch ($accion) {
    ...
    //opciones para la gestión de los problemas. Técnica fall-througth
    case 'crear':
    case 'editar':
    case 'eliminar':
